  ...
  return (
    <GlobalLayout>
      ...
      <section className="py-12 bg-gradient-to-br from-gray-50 to-blue-50 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-xl font-semibold text-center mb-8 text-slate-900">Why Choose Our Legal Service Packages?</h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Fixed Pricing</h3>
              <p className="text-xs text-slate-600">Know exactly what you'll pay upfront. No hidden fees or surprises.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <CheckCircle className="h-6 w-6 text-green-600" />
              </div>
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Verified Lawyers</h3>
              <p className="text-xs text-slate-600">All lawyers are verified members of the Law Society of Kenya.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <FileText className="h-6 w-6 text-purple-600" />
              </div>
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Clear Deliverables</h3>
              <p className="text-xs text-slate-600">Every package lists exactly what you'll receive.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <Clock className="h-6 w-6 text-amber-600" />
              </div>
              <h3 className="text-sm font-semibold text-slate-900 mb-2">Time Estimates</h3>
              <p className="text-xs text-slate-600">Clear delivery timeframes so you can plan accordingly.</p>
            </div>
          </div>
        </div>
      </section>
