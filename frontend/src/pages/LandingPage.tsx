        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            ...
            <nav className="hidden md:flex space-x-6">
              <Link to="/ai" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">
                AI Assistant
              </Link>
              <Link to="/lawyers" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">
                Lawyers
              </Link>
              <Link to="/marketplace" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">
                Documents
              </Link>
              <Link to="/resources" className="text-sm text-slate-600 hover:text-blue-600 transition-colors">
                Resources
              </Link>
            </nav>
            <div className="flex items-center space-x-3">
              {isAuthenticated ? (
                <>
                  <span className="text-xs text-slate-600">Hi, {user?.firstName}</span>
                  <Link 
                    to="/dashboard" 
      ...
      <section className="py-12 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {/* AI Assistant */}
            <div className="bg-white rounded border border-slate-200 p-5 hover:border-blue-400 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            {[
              ...
              <div key={i} className="bg-white rounded border border-slate-200 p-4 hover:border-blue-400 transition-colors">
