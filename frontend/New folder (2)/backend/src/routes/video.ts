...
// Additional endpoints for enhanced video consultation API
router.post('/consultation/:id/start', rateLimiter, startVideoConsultation);
router.post('/consultation/:id/end', rateLimiter, endVideoConsultation);
router.post('/consultation/:id/recording/start', rateLimiter, startRecording);
router.post('/consultation/:id/recording/stop', rateLimiter, stopRecording);
router.get('/consultation/:id/recordings', getConsultationRecordings);
router.get('/consultation/:id/stats', getConsultationStats);
